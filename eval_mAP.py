...
def calcualte_mAP(minoverlap=0.5,gt_PATH=None,dr_PATH=None,img_PATH=None,output_folder=None):
    MINOVERLAP =minoverlap  # default value (defined in the PASCAL VOC2012 challenge)
    ...
    (height)            *
                    (Right,Bottom)
    '''
    if gt_PATH is None or dr_PATH is None or img_PATH is None or output_folder is None:
      print(" PATH for gt_PATH or dr_PATH or img_PATHis or output_folder is Invaid")
    else:
        ...
        if output_folder is not None:
          output_files_path =  output_folder  
