...
def generate_anchors(base_size=16, ratios=None, scales=None):
    if ratios is None:
        #ratios = np.array([1, 1.2599210498948732, 1.5874010519681994])
        #ratios = np.array([0.834, 1, 1.3]) 
        ratios = np.array([0.634, 1, 1.577])
        #ratios = np.array([0.5, 1, 2])

        #ratios = np.array([1, 1, 2]) 
    if scales is None:
        #scales = np.array([2, 1.2599210498948732, 1.5874010519681994])
        #scales = np.array([1, 0.506, 0.641])
